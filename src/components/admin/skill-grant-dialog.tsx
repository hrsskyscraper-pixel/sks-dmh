...
import { grantSkill } from '@/app/(dashboard)/admin/employees/[id]/actions'
...
export function SkillGrantSection({ employeeId, employeeName, availableSkills, certifiedSkillIds, canGrant }: Props) {
