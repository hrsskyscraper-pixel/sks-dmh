...
export default async function TeamPage() {
  ...
  const [
    ...
    db.from('employees').select('id, auth_user_id, name, email, role, employment_type, hire_date, avatar_url, instagram_url, created_at, updated_at').order('hire_date'),
    db.from('skills').select('id, name, phase, category, order_index, target_date_hint, created_at'),
    db.from('achievements')
      .select('id, status, employee_id, skill_id, achieved_at, certified_by, certified_at, cumulative_hours_at_achievement, notes, apply_comment, certify_comment, is_read, created_at, skills(id, name, phase, category, order_index, target_date_hint, created_at), employees!achievements_employee_id_fkey(id, auth_user_id, name, email, role, employment_type, hire_date, avatar_url, instagram_url, created_at, updated_at)')
